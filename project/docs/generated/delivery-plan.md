...
|---|---|---|---|---|---|---|---|---|---|---|
| WRK-001 | 게이트 실행과 증거 무결성 강제 | 완료 | - | MOD-GOV | CHG-004 | REQ-022 | - | - | EVD-008, EVD-009 | - |
| WRK-002 | 병합 훅과 CI 검사 구현 | 완료 | - | MOD-CHG | CHG-005 | REQ-023 | - | WRK-001 | EVD-010, EVD-011 | - |
| WRK-003 | 모듈·마일스톤·작업·인터페이스·의존성 상세 추적 | 완료 | - | MOD-STATUS | CHG-006 | REQ-024 | - | WRK-001 | EVD-012 | - |
| WRK-004 | 결정 대체와 개발 시작 차단 합성 시나리오 | 완료 | - | MOD-QA | CHG-006 | REQ-006, REQ-010, REQ-011 | - | WRK-001 | EVD-013, EVD-014 | - |
| WRK-005 | 운영자·사용자·보안 가이드 자동 생성 | 완료 | - | MOD-DOC | CHG-006 | REQ-025 | - | WRK-003 | EVD-015 | - |
| WRK-006 | Codex·Claude 공통 행동 평가 하네스 | 완료 | - | MOD-AI | CHG-006 | REQ-026 | - | WRK-003 | EVD-016 | - |
| WRK-007 | Codex·Claude 실제 교차 행동 평가 | 할 일 | - | MOD-AI | CHG-006 | REQ-026 | - | WRK-006 | - | - |
| WRK-008 | GitHub 브랜치 보호 기준 구성 | 완료 | - | MOD-CHG | CHG-006 | REQ-027 | - | WRK-002 | EVD-017 | - |
| WRK-009 | GitHub 브랜치 보호 원격 활성화 검증 | 차단됨 | - | MOD-CHG | CHG-006 | REQ-027 | - | WRK-008 | EVD-018 | - |
| WRK-010 | 1인·팀 협업 프로필 양방향 전환 | 완료 | - | MOD-GOV | CHG-007 | REQ-028 | - | WRK-001, WRK-008 | EVD-019 | - |
...
| DPN-005 | IFC-004 | WRK-012 | 계약 | 최신 | 개발 기반 정본 계약이 생성기·검증기와 프로젝트별 UI·운영 파생물 구현의 입력이다. | TC-024와 TC-025 |
