...
- 1인·팀 협업과 Git: [팀 작업 흐름](project-team/05-team-workflow.md)
- 완료·출시·운영: [완료와 출시](project-team/06-completion-and-release.md)

Kit을 개발·export·출시하는 관리자 절차는 프로젝트 배포물에 포함되지 않는다.
