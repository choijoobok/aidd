...
### OI-005 — 원격 저장소 행위자 자동 대조 연결

- **id:** OI-005
- **title:** 원격 저장소 행위자 자동 대조 연결
- **status:** open
- **blocking:** false
- **owner:** DevOps·저장소 관리자
- **due:** -
- **question:** GitHub PR 작성자·승인자·실제 push 행위자를 어떤 API 또는 감사 로그 증거로 가져와 신원 매핑과 자동 대조할 것인가?
- **resolution:** -
- **links:** REQ-029, CHG-008
