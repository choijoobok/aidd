...
상태: 배포물 AIDD 테스트 적합성 위반과 뒤이은 회귀 검사 무력화를 독립 재검토에서 확인·수정한 뒤 새 독립 재검토 대기, 실제 macOS Codex·Claude provider 검증은 고객의 환경 부재로 연기(`in_review`, 출시 준비 미완료)
