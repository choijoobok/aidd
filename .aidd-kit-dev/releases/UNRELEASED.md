...
상태: 후속 독립 C3 검토와 실제 Windows Codex Desktop provider 검증 완료, 실제 macOS Codex·Claude provider 검증은 고객의 환경 부재로 연기(`in_review`, 출시 준비 미완료)
